# [full stack apache2 Fat-Free for everyone with docker compose](https://github.com/damalis/full-stack-apache2-fat-free-for-everyone-with-docker-compose)

If You want to build a website with Fat-Free at short time;

#### Full stack Apache2 Fat-Free:
<p align="left">
<a href="https://fatfreeframework.com" target="_blank" rel="noreferrer"> <img src="https://avatars.githubusercontent.com/u/199570?v=4" alt="Fat-Free" height="40" width="40"/> </a>&nbsp;&nbsp;&nbsp; 
...
The containers are now built and running. You should be able to access the Fat-Free installation with the configured IP in the browser address. `https://DOMAIN_NAME`.
...
[https://fatfreeframework.com/3.9/databases](https://fatfreeframework.com/3.9/databases)
...
[https://fatfreeframework.com/3.9/cache](https://fatfreeframework.com/3.9/cache)
...
[https://fatfreeframework.com/3.9/optimization](https://fatfreeframework.com/3.9/optimization)
